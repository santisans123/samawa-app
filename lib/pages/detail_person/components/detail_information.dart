...
class DetailInformation extends StatefulWidget {
  const DetailInformation({Key? key,
  }) : super(key: key);
    ...
    return Column(
        children: [
          TextInformation(
            ...
            textData: "Lorem Ipsum is simply dummy text of the printing and typesetting",
          ),
          TextInformation(
            textTitle: "Misi Pernikahan",
            textData: "1.Lorem Ipsum is simply dummy text of the printing and typesetting \n"
                "2.Lorem Ipsum is simply dummy text of the printing and typesetting",
          ),
          TextInformation(
            textTitle: "Target Menikah",
            textData: "2024"
          ),
          TextInformation(
              textTitle: "Kesiapan Menikah Menikah",
              textData: "InsyaAllah"
          ),
          TextInformation(
